        ...
        dd = {
            content: [{
                ...
                table: {
                    headerRows: 15,
                    dontBreakRows: true,
                    widths: [30, 70, 'auto', 'auto', 'auto', 'auto', 50, 50, 'auto'],
                    body: [
                        [{
                            image: 'header',
                            width: 500,
                        ...
                        [ 
                            { text: 'PRESUPUESTO:', style: 'tableHeaderVerde', colSpan:2, alignment: 'center'},
                            { },
                            { text: 'CAUSES', style: 'tableHeaderVerde', colSpan:3, alignment: 'center' },
                            { },
                            { },
                        ...
                        [ 
                            { text: 'AUTORIZADO:', style: 'tableHeaderVerde', colSpan:2, alignment: 'center'},
                            { },
                            { text: data.datos.metadato_compra_consolidada.presupuesto_causes || data.datos.metadato_compra_consolidada.presupuesto_causes == 0 ? ('$ ' +  data.datos.metadato_compra_consolidada.presupuesto_causes.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')) : 'No disponible', style: 'tableHeader', colSpan:3, alignment: 'right'  },
                            { },
                            { },
                        ...
                        [ 
                            { text: 'ASIGNADO:', style: 'tableHeaderVerde', colSpan:2, alignment: 'center'},
                            { },
                            { text: data.datos.metadato_compra_consolidada.presupuesto_causes_asignado || data.datos.metadato_compra_consolidada.presupuesto_causes_asignado == 0 ? ('$ ' +  data.datos.metadato_compra_consolidada.presupuesto_causes_asignado.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')) : 'No disponible', style: 'tableHeader', colSpan:3, alignment: 'right'  },
                            { },
                            { },
                        ...
                        [ 
                            { text: 'DISPONIBLE:', style: 'tableHeaderVerde', colSpan:2, alignment: 'center'},
                            { },
                            { text: data.datos.metadato_compra_consolidada.presupuesto_causes_disponible || data.datos.metadato_compra_consolidada.presupuesto_causes_disponible == 0 ? ('$ ' +  data.datos.metadato_compra_consolidada.presupuesto_causes_disponible.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')) : 'No disponible', style: 'tableHeader', colSpan:3, alignment: 'right'  },
                            { },
                            { },
                        ...
                        [
                            ...
                            { text: 'DESCRIPCIÓN', style: 'tableHeaderVerde', colSpan: 3, alignment: 'center' },
                            { },
                            { },
                            { text: 'PRECIO', style: 'tableHeaderVerde', alignment: 'center' },
                            { text: 'CANTIDAD SOLICITADA', style: 'tableHeaderVerde', alignment: 'center' },
                            { text: 'CANTIDAD AJUSTADA', style: 'tableHeaderVerde', alignment: 'center' },
                ...
                for (var j in data.lista) {
                    ...
                    dd.content[0].table.body.push(
                        [
                            ...
                            { text: insumo.info_insumo.descripcion ? insumo.info_insumo.descripcion : 'No disponible' , style: 'tableRow', colSpan:3, alignment: 'left' },
                            { },
                            { },
                            { text: insumo.precio_unitario ?  ('$   ' + Number(insumo.precio_unitario).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')) : 'No disponible' , style: 'tableRow', alignment: 'right' },
                            { text: insumo.cantidad_enviada ? insumo.cantidad_enviada : 'No disponible' , style: 'tableRow', alignment: 'right' },
                            { text: insumo.cantidad_solicitada ? insumo.cantidad_solicitada : 'No disponible' , style: 'tableRow', alignment: 'right' },
                            { text: insumo.monto_solicitado ? ('$   ' + Number(insumo.monto_solicitado).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')) : 'No disponible' , style: 'tableRow', alignment: 'right' }
                        ],
                    );
                    i_insumo++;
                }
