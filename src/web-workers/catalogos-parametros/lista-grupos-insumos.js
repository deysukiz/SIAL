    ...
    function pdf(data) {
            ...
            content: [{
                ...
                table: {
                    ...
                    body: [
                        ...
                        [{ text: 'LISTA DE GRUPO DE INSUMOS', style: 'tableHeaderTop', colSpan: 7, alignment: 'center' },
                            {}, {}, {}, {}, {}, {}
                        ],[
                        ...
                        [
                            ...
                            { text: 'TIPO', style: 'tableHeaderVerde', colSpan: 2, alignment: 'center' },
                            { },
                            { text: 'SERVIDOR', style: 'tableHeaderVerde', colSpan: 4,alignment: 'center' },
                            { },
                            { },
                            { },
                        ]
        ...
        for (var i in data.lista) {
            ...
            dd.content[0].table.body.push([
                    ...
                    { text: movimiento.tipo ? movimiento.tipo : 'No disponible', style: 'tableRow', colSpan: 2, alignment: 'center' },
                    { },
                    { text: movimiento.nombre ? movimiento.nombre : 'No disponible', style: 'tableRow', colSpan: 4, alignment: 'left' },
                    { },
                    { },
                    { },
                ]);
        ...
        pdfMake.createPdf(dd).getBase64(function(base64) {
            postMessage({ fileName: 'Lista_Grupo_Insumos.pdf', base64: base64 });
        });
    }
