...
(function() {
    ...
    function pdf(data) {
        ...
        var donacion = [ 
                            ...
                            { text: data.datos.movimiento_salida_metadatos_a_g.donacion == null ? 'No disponible' : data.datos.movimiento_salida_metadatos_a_g.donacion == 1 || data.datos.movimiento_salida_metadatos_a_g.donacion == '1' ? 'Donación' : 'No disponible', style: 'tableHeader', alignment: 'left' },
                            { text: 'DONANTE:', style: 'tableHeaderVerde', colSpan:2, alignment: 'right' },
                            {},
                            { text: data.datos.movimiento_salida_metadatos_a_g.donante ? data.datos.movimiento_salida_metadatos_a_g.donante : 'No disponible', style: 'tableHeader',  colSpan:2, alignment: 'left' },
                            { },
                            { text: 'RECIBE:', style: 'tableHeaderVerde', alignment: 'right' },
                            { text: data.datos.movimiento_salida_metadatos_a_g.persona_recibe ? data.datos.movimiento_salida_metadatos_a_g.persona_recibe : 'No disponible', style: 'tableHeader', colSpan:2, alignment: 'left' },
                            { }
                        ];
        ...
        var no_donacion_1 = [ 
                                ...
                                {},
                                { text: data.datos.movimiento_salida_metadatos_a_g.numero_pedido ? data.datos.movimiento_salida_metadatos_a_g.numero_pedido : 'No disponible', style: 'tableHeader', alignment: 'left' },
                                { text: 'FOLIO FACTURA:', style: 'tableHeaderVerde', colSpan:2, alignment: 'right' },
                                { },
                                { text: data.datos.movimiento_salida_metadatos_a_g.folio_factura ? data.datos.movimiento_salida_metadatos_a_g.folio_factura : 'No disponible', style: 'tableHeader', colSpan:2, alignment: 'left' },
                                { }
                            ];
        var no_donacion_2 = [ 
                                { text: 'CLUES DESTINO:', style: 'tableHeaderVerde', alignment: 'right' },
                                { text: data.datos.movimiento_salida_metadatos_a_g.unidad_medica ?  ' ' + data.datos.movimiento_salida_metadatos_a_g.unidad_medica.clues +  ' - ' + data.datos.movimiento_salida_metadatos_a_g.unidad_medica.nombre  : 'No disponible', style: 'tableHeader', colSpan:4, alignment: 'left' },
                                { },
                                { },
                                { },
                                { text: 'RECIBE:', style: 'tableHeaderVerde', alignment: 'right' },
                                { text: data.datos.movimiento_salida_metadatos_a_g.persona_recibe ? data.datos.movimiento_salida_metadatos_a_g.persona_recibe : 'No disponible', style: 'tableHeader', colSpan:3,  alignment: 'left'  },
                                { },
                                { }
                            ];    
                        
        if (data.datos.movimiento_salida_metadatos_a_g.donacion == '1' || data.datos.movimiento_salida_metadatos_a_g.donacion == 1) {
            fila_extra = donacion;
            ...
            content: [{
                ...
                table: {
                    ...
                    body: [
                        ...
                        [{ text: 'SALIDA DE ARTÍCULOS', style: 'tableHeaderTop', colSpan: 9, alignment: 'center' },
                            {}, {}, {}, {}, {}, {},{}, {} 
                        ],
                        [
...
/*************************AQUI VAN DONACIONES O NO DONACIONES********************* */
        ...
        fecha_hoy = moment().format('YYYY-MM-DD');
            ...
            moment.locale('es');
                for (var j in data.lista) {
                    ...
                    for (var c in insumo.articulos.articulos_metadatos) {
                        var articulo_valores = insumo.articulos.articulos_metadatos[c];
                            if (articulo_valores.valor != '') {
                                valores_metadatos += ' ' + articulo_valores.campo + ': ' + articulo_valores.valor + '. ';
                            }
                    }
        ...
        //                 id: null,
        //                 clave: null,
        //                 nombre: data.datos.movimiento_salida_metadatos_a_g.proveedor ? data.datos.movimiento_salida_metadatos_a_g.proveedor.nombre  : ''
        //             },
        //         cargo_id:null,
        //         created_at:null,
        //         deleted_at:null,
        ...
        //             almacen_id: null,
        //             documento_sistema_cargo_id: null,
        //             nombre: data.datos.movimiento_salida_metadatos_a_g.persona_recibe ? data.datos.movimiento_metadato.persona_recibe : '______________________________'
        //         },
        //         id:"1",
        //         leyenda:"ENTREGÓ",
        //         updated_at:null,
        ...
        pdfMake.createPdf(dd).getBase64(function(base64) {
            postMessage({ fileName: 'SALIDA_ESTANDAR_ARTICULO_' + data.datos.id + '.pdf', base64: base64 });
        });
    }
