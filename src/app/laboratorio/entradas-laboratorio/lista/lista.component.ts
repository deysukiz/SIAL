...
export class ListaComponent {
  ...
  ngOnInit() {
    ...
    this.pdfworker = new Worker('web-workers/laboratorio/lista-entradas.js');
   ...
   */
  export_excel() {
    let titulo = 'Entrada Laboratorio';
    ...
    try {
        FileSaver.saveAs(blob,  'Listado_entrada_de_laboratorio.xls');
    } catch (e) {
      console.log(e);
    }
  }
