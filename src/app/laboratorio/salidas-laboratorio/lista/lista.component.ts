...
export class ListaComponent implements OnInit {
   ...
   */
  export_excel() {
    let titulo = 'Salida Laboratorio Clínico';
    ...
    try {
        FileSaver.saveAs(blob,  'salida_laboratorio.xls');
    } catch (e) {
      console.log(e);
    }
  }
  ...
  imprimir() {
    try {
      ...
      this.crudService.lista_general('salida-laboratorio?tipo=2&fecha_desde=' + this.fecha_desde
