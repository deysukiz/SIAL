...
export class ListaComponent implements OnInit {
	...
	pacientesEgreso: PacienteEgreso[] = [];
	...
	ngOnInit() {
	    ...
	    .switchMap((term:string)  =>  { 
	      ...
	      this.cargando = true;
	      return term  ? this.egresoService.buscar(term, this.paginaActualBusqueda, this.resultadosPorPaginaBusqueda) : Observable.of<any>({data:[]}) 
	    }
	...
	listarBusqueda(term:string ,pagina:number): void {
	    ...
	    this.cargando = true;
	    this.egresoService.buscar(term, pagina, this.resultadosPorPaginaBusqueda).subscribe(
	        resultado => {
	          this.cargando = false;
	  ...
	  listar(pagina:number): void {
	    ...
	    this.cargando = true;
	    this.egresoService.lista(pagina,this.resultadosPorPagina).subscribe(
	        resultado => {

	          this.cargando = false;
	          this.pacientesEgreso = resultado.data as PacienteEgreso[];
