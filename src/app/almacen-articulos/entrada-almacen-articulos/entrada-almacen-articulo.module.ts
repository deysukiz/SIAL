...
import { EntradasAlmacenArticuloRoutingModule } from './entrada-almacen-articulo-routing.module';
...
@NgModule({
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    EntradasAlmacenArticuloRoutingModule,
    HubModule,
    PerfilModule,
...
export class EntradasAlmacenArticuloModule { }
