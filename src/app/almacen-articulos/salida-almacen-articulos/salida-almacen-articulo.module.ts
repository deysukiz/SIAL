...
import { SalidasAlmacenArticuloRoutingModule } from './salida-almacen-articulo-routing.module';
...
@NgModule({
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    SalidasAlmacenArticuloRoutingModule,
    HubModule,
    PerfilModule,
...
export class SalidasAlmacenArticuloModule { }
