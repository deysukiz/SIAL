...
export class ListaComponent {
   ...
   * @type {string} */
    servicio = '';
  /**
   * Variable que contiene el valor de la consulta a la API.
   * @type {string} */
    query = '';
  /**
  ...
  export_excel() {
    ...
    + '</th><th>q: ' + this.query + '</th></tr><tr><th colspan=\'7\'></th></tr></table>';
  ...
  imprimir() {
    ...
    this.crudService.lista_general('inicializar-inventario-me?fecha_desde=' + this.fecha_desde
